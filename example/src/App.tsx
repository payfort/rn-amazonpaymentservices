...
export default function App() {
  ...
  const requestShaPhrase = '78hAlOzzVf96fshlJ0cWwB]#'; // Set your request SHA phrase here.
  ...
  const buttonAction = async (option: string) => {
    try {
      ...
      const requestBody: RequestBody = {
        ...
        access_code: '81OlL4cJCuhDaGSb5dZ5',
        merchant_identifier: 'bYqNmale',
        language: 'en',
        device_id: deviceId,
      };

      requestBody.signature = createSignature(requestBody, requestShaPhrase);
